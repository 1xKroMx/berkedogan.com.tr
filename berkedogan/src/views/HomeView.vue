...
function handleTechClick(name: string) {
  const expected = secretPattern[userPattern.value.length]
        ...
        <div class="hero-visual">
          <div class="code-preview">
            <div class="code-header">
              ...
              <span class="code-title">portfolio.vue</span>
            </div>
            <div class="code-content">
              <div class="code-line">
                ...
                <span class="code-string">"Berke Doğan"</span>
              </div>
              <div class="code-line">
                <span class="code-keyword">const</span> 
              ...
              <div class="code-line code-indent">
                <span class="code-string">"Vue.js"</span><span class="code-operator">,</span>
              </div>
              <div class="code-line code-indent" >
                <span class="code-string">"TypeScript"</span><span class="code-operator">,</span>
              </div>
              <div class="code-line code-indent">
                <span class="code-string">"JavaScript"</span><span class="code-operator">,</span>
              </div>
              <div class="code-line code-indent">
      ...
      <div class="container">
        ...
        <div class="tech-grid">
          <div class="tech-item" v-for="tech in technologies" :key="tech.name">
            ...
            <span class="tech-name" @click="handleTechClick(tech.name)">{{ tech.name }}</span>
          </div>
        </div>
      </div>
    </section>

    <PasswordModal v-if="authMode" />
...
.hero-section {
  ...
  background: linear-gradient(135deg, var(--color-background) 0%, #f0f4ec 100%);
}
...
.code-keyword { color: #f093c4; }
.code-variable { color: #81d4fa; }
.code-operator { color: #ffcc02; }
